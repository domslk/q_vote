...
var app = (function () {
    ...
    */
    ...
    // (75:12) {#each filteredSchools as school}
    function create_each_block(ctx) {
    	let li;
    	let t_value = /*school*/ ctx[12].name + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			t = text(t_value);
    			add_location(li, file, 75, 12, 2302);
    		},
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*filteredSchools*/ 4 && t_value !== (t_value = /*school*/ ctx[12].name + "")) set_data_dev(t, t_value);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(75:12) {#each filteredSchools as school}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value = /*filteredSchools*/ ctx[2];
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			h2 = element("h2");
    			h2.textContent = "List of schools below";
    			t7 = space();
    			ul = element("ul");
    			...
    			attr_dev(h1, "class", "svelte-76l38o");
    			add_location(h1, file, 66, 8, 1943);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "placeholder", "add school");
    			add_location(input0, file, 68, 8, 1967);
    			add_location(button, file, 69, 8, 2043);
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "placeholder", "search");
    			add_location(input1, file, 71, 8, 2101);
    			add_location(h2, file, 72, 8, 2200);
    			add_location(ul, file, 73, 8, 2239);
    			attr_dev(main, "class", "svelte-76l38o");
    			add_location(main, file, 65, 4, 1928);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input0, /*newSchool*/ ctx[1]);
    			append_dev(main, t2);
    			append_dev(main, button);
    			append_dev(main, t4);
    			append_dev(main, input1);
    			set_input_value(input1, /*searchInput*/ ctx[0]);
    			append_dev(main, t5);
    			append_dev(main, h2);
    			append_dev(main, t7);
    			append_dev(main, ul);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*addSchool*/ ctx[3], false, false, false, false),
    					listen_dev(input1, "input", /*input1_input_handler*/ ctx[7]),
    					listen_dev(input1, "input", /*searchSchools*/ ctx[4], false, false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*newSchool*/ 2 && input0.value !== /*newSchool*/ ctx[1]) {
    				set_input_value(input0, /*newSchool*/ ctx[1]);
    			}

    			if (dirty & /*searchInput*/ 1 && input1.value !== /*searchInput*/ ctx[0]) {
    				set_input_value(input1, /*searchInput*/ ctx[0]);
    			}

    			if (dirty & /*filteredSchools*/ 4) {
    				each_value = /*filteredSchools*/ ctx[2];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const addSchool = async () => {
    		if (newSchool != "") {
    			try {
    				await addDoc(collection(database, "schools"), { name: newSchool });
    			} catch(e) {
    	...
    	const searchSchools = async () => {
    		const q = query(collection(database, "schools"), where("name", ">=", searchInput));
    	...
    	function input0_input_handler() {
    		newSchool = this.value;
    		$$invalidate(1, newSchool);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ('newSchool' in $$props) $$invalidate(1, newSchool = $$props.newSchool);
    		if ('searchInput' in $$props) $$invalidate(0, searchInput = $$props.searchInput);
    		if ('schools' in $$props) $$invalidate(5, schools = $$props.schools);
    		if ('filteredSchools' in $$props) $$invalidate(2, filteredSchools = $$props.filteredSchools);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*schools, searchInput*/ 33) {
    			$$invalidate(2, filteredSchools = schools.filter(school => school.name.toLowerCase().includes(searchInput.toLowerCase())));
    		}
    	};
